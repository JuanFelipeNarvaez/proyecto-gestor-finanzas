        ...
        <ion-content fullscreen>
            <div id="container">
                <div class="nuevo-registro">
                    <ion-button @click="openModalAdd"><ion-icon :icon="IonIcons.addSharp"
                            color="sucess"></ion-icon></ion-button>
                </div>
                ...
                <ion-modal :is-open="modalIsOpen" @didDismiss="modalIsOpen = false" :css-class="['my-custom-modal']">
                    <div class="modal-content">
                        <div id="data-form">
                            ...
                            <InputComponent v-model="comentario" id="comentario" name="comentario"
                                label="Comentario: " />
                        </div>
                        <div>
